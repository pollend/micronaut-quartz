...
include::{includedir}configurationProperties/io.micronaut.quartz.configuration.QuartzClientConfiguration.adoc[]
include::{includedir}configurationProperties/io.micronaut.quartz.configuration.QuartzConfiguration.adoc[]
include::{includedir}configurationProperties/io.micronaut.quartz.configuration.QuartzTriggerConfiguration.adoc[]
